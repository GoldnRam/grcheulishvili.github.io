...
**Role:**
A custom intelligence pipeline that ingests and filters regional threat feeds.
...
**Status:** [DESIGN PHASE]
**Concept:**
Replacing the default CTFd scoreboard logs with a custom ELK Stack to capture granular system-level telemetry (Syscalls, Process Creation).
